...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            name='_add_matrix', sources=['./src/add_matrix/add_matrix.cpp', './src/add_matrix/add_matrix_kernel.cu']
        ),
        CUDAExtension(
            name='_scale_exp', sources=['./src/scale_exp/scale_exp.cpp', './src/scale_exp/scale_exp_kernel.cu']
        ),
    ],
